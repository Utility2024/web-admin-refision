...
use App\Filament\Esd\Resources\PackagingResource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use Filament\Infolists\Components\Card as InfolistCard;
use pxlrbt\FilamentExcel\Actions\Tables\ExportBulkAction;
use App\Filament\Esd\Resources\PackagingResource\RelationManagers;

use App\Filament\Esd\Resources\PackagingResource\RelationManagers\PackagingDetailRelationManager;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('related_count')
                    ...
                    ->color('primary')
                    ->getStateUsing(function ($record) {
                        return PackagingDetail::where('packaging_id', $record->id)->count();
                    }),
                ...
                Tables\Actions\BulkAction::make('Export Pdf')
                        ...
                        ->action(function (Collection $records) {
                            return response()->streamDownload(function () use ($records) {
                                echo Pdf::loadHTML(
                                    Blade::render('Packagingpdf', ['records' => $records])
                                )->stream();
                            }, 'Packaging.pdf');
                        }),
